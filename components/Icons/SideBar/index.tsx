...
const EComerceIcon = ({ pathname }: Props) => {
  return (
    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
      <path
        className={`fill-current text-slate-400 ${
          pathname.includes("clinics") && "text-indigo-300"
        }`}
        d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"
      />
      <path
        className={`fill-current text-slate-700 ${
          pathname.includes("clinics") && "!text-indigo-600"
        }`}
        d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z"
      />
      <path
        className={`fill-current text-slate-600 ${
          pathname.includes("clinics") && "text-indigo-500"
        }`}
...
const CommunityIcon = ({ pathname }: Props) => {
  return (
    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
      <path
        className={`fill-current text-slate-600 ${
          pathname.includes("users") && "text-indigo-500"
        }`}
        d="M18.974 8H22a2 2 0 012 2v6h-2v5a1 1 0 01-1 1h-2a1 1 0 01-1-1v-5h-2v-6a2 2 0 012-2h.974zM20 7a2 2 0 11-.001-3.999A2 2 0 0120 7zM2.974 8H6a2 2 0 012 2v6H6v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5H0v-6a2 2 0 012-2h.974zM4 7a2 2 0 11-.001-3.999A2 2 0 014 7z"
      />
      <path
        className={`fill-current text-slate-400 ${
          pathname.includes("users") && "text-indigo-300"
        }`}
...
const FinanceIcon = ({ pathname }: Props) => {
  return (
    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
      ...
      <path
        className={`fill-current text-slate-700 ${
          pathname.includes("finance") && "!text-indigo-500"
        }`}
...
const TaskIcon = ({ pathname }: Props) => {
  return (
    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
      <path
        className={`fill-current text-slate-600 ${
          pathname.includes("roles") && "text-indigo-500"
        }`}
      ...
      <path
        className={`fill-current text-slate-400 ${
          pathname.includes("roles") && "text-indigo-300"
        }`}
...
const CampainIcon = ({ pathname }: Props) => {
  return (
    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
      <path
        className={`fill-current text-slate-600 ${
          pathname.includes("services") && "text-indigo-500"
        }`}
        d="M20 7a.75.75 0 01-.75-.75 1.5 1.5 0 00-1.5-1.5.75.75 0 110-1.5 1.5 1.5 0 001.5-1.5.75.75 0 111.5 0 1.5 1.5 0 001.5 1.5.75.75 0 110 1.5 1.5 1.5 0 00-1.5 1.5A.75.75 0 0120 7zM4 23a.75.75 0 01-.75-.75 1.5 1.5 0 00-1.5-1.5.75.75 0 110-1.5 1.5 1.5 0 001.5-1.5.75.75 0 111.5 0 1.5 1.5 0 001.5 1.5.75.75 0 110 1.5 1.5 1.5 0 00-1.5 1.5A.75.75 0 014 23z"
      />
      <path
        className={`fill-current text-slate-400 ${
          pathname.includes("services") && "text-indigo-300"
        }`}
