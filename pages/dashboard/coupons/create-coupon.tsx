...
export default function CreateCoupon() {
  ...
  return (
    <>
      ...
      <div className="sm:flex sm:items-center max-w-[760px] m-auto mt-6">
      ...
      >
            ...
            <>
              ...
              {client ? (
                <div className="grid grid-cols-4 gap-10">
                  <label className="block text-sm font-medium text-end">Khách hàng</label>
        ...
        {(typeCoupon == "orther" || typeCoupon == "client") && (
          <div className="grid grid-cols-4 gap-10">
            <label htmlFor="date" className="block text-sm font-medium required text-end">
